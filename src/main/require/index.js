...
module.exports = {
  ...
  jsFilesIn: absoluteDir => entriesIn(absoluteDir, it => /\.js$/.test(it)),
  jsFilesExceptIndexIn: absoluteDir => entriesIn(absoluteDir, it => /\.js$/.test(it) && !/index\.js$/.test(it)),
  jsonFilesIn: absoluteDir => entriesIn(absoluteDir, it => /\.json$/.test(it))
}
